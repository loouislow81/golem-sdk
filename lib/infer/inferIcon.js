...
function getMatchingIcons(iconsWithScores, maxScore) {
  return iconsWithScores.filter(function (item) {
    ...
    return Object.assign({}, item, {
      ext: _path2.default.extname(item.url)
    });
  });
}
...
function inferIconFromStore(targetUrl, platform) {
  ...
  return (0, _gitcloud2.default)('https://loouislow81.github.io/golem-icons/').then(function (fileIndex) {
...
function inferFromPage(targetUrl, platform, outDir) {
  ...
  return (0, _pageIcon2.default)(targetUrl, {
    ext: preferredExt
  }).then(function (icon) {
    if (!icon) {
      return null;
